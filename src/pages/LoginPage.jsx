...
// It receives the `setUser` function from App.jsx to update the login state
const LoginPage = ({ setUser }) => {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      // THE FIX:
      // 1. Update the application's state with the logged-in user
      setUser(loggedInUser);
      // 2. Navigate to the announcements page
      navigate('/announcements');
      // 3. The problematic `window.location.reload()` has been removed.
